...
private void initViewer(WebChartViewer viewer)
{
    ...
    Date startDate = new GregorianCalendar(2007, 0, 1).getTime();
    Date endDate = new GregorianCalendar(2012, 0, 1).getTime();
...
private void drawChart(WebChartViewer viewer)
{
    ...
    r.setDateCol(0, new GregorianCalendar(2007, 0, 1).getTime(), 86400);
