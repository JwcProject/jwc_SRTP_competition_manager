...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div id="main" class="wrapper clearfix">
		    <form action="QuerySchoolAnnoun" method="post">
		        <table width="100%">
		           <tr>
		              <td>公告名称:<input type="text" name="announTitle" id="announTitle"/></td>
		              <td>发布状态:<select name="checkState" id="checkState" >
		         ...
		         <tr>
					  ...
					  <td>公告类型:<select name="announTypeName" id="announTypeName" >
					                                <option value="">所有</option>
													<option value="学生公告">学生公告</option>
													<option value="教师公告">教师公告</option>
													<option value="学院公告">学院公告</option>
													<option value="教务处公告">学院公告</option>
					  </select></td>
