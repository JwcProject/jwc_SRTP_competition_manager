...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div id="main" class="wrapper clearfix">
		    <form action="QueryStuTeaAnnoun" method="post">
		        <table width="100%">
		           <tr>
				...
				<div class="con-box">
					<div class="con">
						<table cellpadding="0" cellspacing="0" class="info-table"
							...
							<s:iterator value="listAnnouncementModels" id="listAnnouncementModels">
							  <tr onMouseOver="this.style.backgroundColor='#D0E9ED'" onMouseOut="this.style.backgroundColor=''">
								...
								<td align="center">
									...
									<s:if test="#listAnnouncementModels.publishState=='N '">
											<s:a href="CommitSavedAnnouncement?announId=%{#listAnnouncementModels.announId}" >发布</s:a>
								    </s:if> 
								     <s:else>
								     </s:else>
								</td>
							...
							<tr>
								<s:url id="firstPage" action="ListStTeaAnnoun">
									<s:param name="page" value="1"></s:param>
								</s:url>
								<s:url id="url_pre" action="ListStTeaAnnoun">
									<s:param name="page" value="page-1"></s:param>
								</s:url>
								<s:url id="url_next" action="ListStTeaAnnoun">
									<s:param name="page" value="page+1"></s:param>
								</s:url>
								<s:url id="lastPage" action="ListStTeaAnnoun">
