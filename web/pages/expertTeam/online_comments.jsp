...
<div id="container">
  ...
  <table class="cx_tablemain" border="1" bordercolor="#a9cfe2" cellpadding="3" cellspacing="0" width="100%">
    <tr>
      <td class="cx_table"><div class="cx_title">项目申报表</div></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td height="25">项目实施时间：
          <s:date name="declaration.startOn" format="yyyy-MM-dd"/> 至 <s:date name="declaration.endOn" format="yyyy-MM-dd"/></td>
      ...
      <td height="35">
        ...
        <form id="opinionForm" action="AddComments" method="post">
          ...
          <table border="0" cellpadding="0" cellspacing="0" width="100%">
            ...
            <tr>
              <td height="30"><textarea name="declComment.declArgument" cols="80" rows="6" id="textfield2" style="border:1px solid #CCC;"
...
　评分
<input name="declComment.declScore" id="declComment.declScore" size="10" class="cxinput" type="text" 
